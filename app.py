...
initiation_query_string = '''
    ...
    CREATE (researchActivityObjetiveRelationBasicUnit_Ind)-[:HAS_SEMANTIC_UNIT_SUBJECT {{category:"ObjectPropertyExpression", URI:"orkg_hasSemanticUnitSubject", entry_URI:"entry_uri", simpleDescriptionUnit_URI:"new_individual_uri2", basicUnit_URI:"new_individual_uri12"}}]->(ResearchActivity)
