...
initiation_query_string = '''
    ...
    CREATE (researchActivityOutputAssertion:orkg_ResearchActivityOutputRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research activity output relation assertion", description:"This assertion models the relation between a particular research activity and one of its research result outputs.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000299"], relevant_classes_URI:["http://orkg???????1", "http://orkg???????5"], URI:"Research_Activity_Output_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchActivityOutputRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchActivityMethodRelationAssertion:orkg_ResearchActivityMethodRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research activity method relation assertion", description:"This assertion models the relation between a particular research activity and one the research methods it realizes.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000055"], relevant_classes_URI:["http://orkg???????5", "http://orkg???????4"], URI:"Research_Activity_Method_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchActivityMethodRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchActivityObjectiveRelationAssertion:orkg_ResearchActivityObjectiveRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research activity objective relation assertion", description:"This assertion models the relation between a particular research activity and one the research objectives it achieves.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000417"], relevant_classes_URI:["http://orkg???????5", "http://orkg???????3"], URI:"Research_Activity_Objective_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchActivityObjectiveRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchActivityParthoodAssertion:orkg_ResearchActivityParthoodAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research activity parthood assertion", description:"This assertion models the relation between a particular research activity and its activity parts (i.e. steps).", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000117"], relevant_classes_URI:["http://orkg???????5"], URI:"Research_Activity_Parthood_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchActivityParthoodAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchMethodParthoodAssertion:orkg_ResearchMethodParthoodAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research method parthood assertion", description:"This assertion models the relation between a particular research method and its method parts (i.e. steps).", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????4"], URI:"Research_Method_Parthood_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchMethodParthoodAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchMethodObjectiveRelationAssertion:orkg_ResearchMethodObjectiveRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research method objective relation assertion", description:"This assertion models the relation between a particular research method and its objective specification part.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????4", "http://orkg???????3"], URI:"Research_Method_Objective_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchMethodObjectiveRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchMethodActivityRelationAssertion:orkg_ResearchMethodActivityRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research method activity relation assertion", description:"This assertion models the relation between a particular research method and the activity that realizes it.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000055"], relevant_classes_URI:["http://orkg???????4", "http://orkg???????5"], URI:"Research_Method_Activity_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchMethodActivityRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchResultParthoodAssertion:orkg_ResearchResultParthoodAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research result parthood assertion", description:"This assertion models the relation between a particular research result and its result parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????1"], URI:"Research_Result_Parthood_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchResultParthoodAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchResultActivityRelationAssertion:orkg_ResearchResultActivityRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research result activity relation assertion", description:"This assertion models the relation between a particular research result and the research activity that has it as its output.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000299"], relevant_classes_URI:["http://orkg???????1", "http://orkg???????5"], URI:"Research_Result_Activity_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchResultActivityRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchResultObjectiveRelationAssertion:orkg_ResearchResultObjectiveRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research result objective relation assertion", description:"This assertion models the relation between a particular research result and the research objective that achieved it.", relevant_properties_URI:["http://orkg_has_achieved_result"], relevant_classes_URI:["http://orkg???????1", "http://orkg???????3"], URI:"Research_Result_Objective_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchResultObjectiveRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchResultMaterialEntityRelationAssertion:orkg_ResearchResultMaterialEntityRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research result material entity relation assertion", description:"This assertion models the relation between a particular research result and a material entity that the result is about.", relevant_properties_URI:["http://purl.obolibrary.org/obo/IAO_0000136"], relevant_classes_URI:["http://orkg???????1", "http://purl.obolibrary.org/obo/BFO_0000040"], URI:"Research_Result_Material_Entity_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchResultMaterialEntityRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchObjectiveParthoodAssertion:orkg_ResearchObjectiveParthoodAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research objective parthood assertion", description:"This assertion models the relation between a particular research objective and its objective parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????3"], URI:"Research_Objective_Parthood_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchObjectiveParthoodAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchObjectiveMethodRelationAssertion:orkg_ResearchObjectiveMethodRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research objective method relation assertion", description:"This assertion models the relation between a particular research objective and the method of which it is a part.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????3", "http://orkg???????4"], URI:"Research_Objective_Method_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchObjectiveMethodRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchObjectiveActivityRelationAssertion:orkg_ResearchObjectiveActivityRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research objective research activity relation assertion", description:"This assertion models the relation between a particular research objective and the research activity that achieves it.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000417"], relevant_classes_URI:["http://orkg???????5", "http://orkg???????4"], URI:"Research_Objective_Activity_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchObjectiveActivityRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (researchObjectiveResultRelationAssertion:orkg_ResearchObjectiveResultRelationAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg research objective result relation assertion", description:"This assertion models the relation between a particular research objective and the research result that it achieved.", relevant_properties_URI:["http://orkg_has_achieved_result"], relevant_classes_URI:["http://orkg???????3", "http://orkg???????1"], URI:"Research_Objective_Result_Relation_Assertion_URI", category:"ClassExpression", KGBB_URI:"ResearchObjectiveResultRelationAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)

    CREATE (materialEntityParthoodAssertion:orkg_MaterialEntityParthoodAssertion:orkg_Assertion:iao_DocumentPart:iao_InformationContentEntity:ClassExpression:Entity {{name:"orkg material entity parthood assertion", description:"This assertion models the relation between a particular material entity and its material entity parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://purl.obolibrary.org/obo/BFO_0000040"], URI:"Material_Entity_Parthood_Assertion_URI", category:"ClassExpression", KGBB_URI:"MaterialEntityParthoodAssertionKGBB_URI"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(Ass)
    ...
    CREATE (ResearchActivityTopic_ind)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"entry_uri", topic_URI:"new_individual_uri4"}}]->(ResearchResultTopic_ind:orkg_ResearchResultTopic_IND:orkg_Topic_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research result topic unit", description:"This topic unit models a research result documented in a particular research paper.", URI:"new_individual_uri4", topic_URI:"new_individual_uri4", type:"ResearchResult_topic_class_URI", node_type:"topic", category:"NamedIndividual", entry_URI:"entry_uri", KGBB_URI:"ResearchResultTopicKGBB_URI", object_URI:"new_individual_uri5", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], topic_label:"Research result"}})

    CREATE (ResearchActivityTopic_ind)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri10"}}]->(researchActivityOutputAssertion_Ind:orkg_ResearchActivityOutputRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research activity output relation assertion unit", description:"This assertion unit models the relation between a particular research activity and one of its research result outputs.", URI:"new_individual_uri10", assertion_URI:"new_individual_uri10", topic_URI:"new_individual_uri2", type:"Research_Activity_Output_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"entry_uri", KGBB_URI:"ResearchActivityOutputRelationAssertionKGBB_URI", object_URI:"new_individual_uri5", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research activity output"}})

    CREATE (ResearchActivityTopic_ind)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri11"}}]->(researchActivityMethodAssertion_Ind:orkg_ResearchActivityMethodRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research activity method relation assertion unit", description:"This assertion unit models the relation between a particular research activity and one of the research methods it realizes.", URI:"new_individual_uri11", assertion_URI:"new_individual_uri11", topic_URI:"new_individual_uri2", type:"Research_Activity_Method_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"entry_uri", KGBB_URI:"ResearchActivityMethodRelationAssertionKGBB_URI", object_URI:"new_individual_uri7", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research activity method"}})
    ...
    CREATE (researchActivityOutputAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri10"}}]->(ResearchActivity)

    CREATE (researchActivityOutputAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri10"}}]->(ResearchResultTopic_ind)
    ...
    CREATE (researchActivityMethodAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri11"}}]->(ResearchActivity)

    CREATE (researchActivityMethodAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri11"}}]->(ResearchMethodTopic_ind)
    ...
    CREATE (ResearchActivityTopic_ind)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri12"}}]->(researchActivityObjetiveRelationAssertion_Ind:orkg_ResearchActivityObjectiveRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research activity objective relation assertion unit", description:"This assertion unit models the relation between a particular research activity and one of the research objectives it achieves.", URI:"new_individual_uri12", assertion_URI:"new_individual_uri12", topic_URI:"new_individual_uri2", type:"Research_Activity_Objective_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"entry_uri", KGBB_URI:"ResearchActivityObjectiveRelationAssertionKGBB_URI", object_URI:"new_individual_uri9", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research activity objective"}})
    ...
    CREATE (researchActivityObjetiveRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri12"}}]->(ResearchActivity)

    CREATE (researchActivityObjetiveRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"entry_uri", topic_URI:"new_individual_uri2", assertion_URI:"new_individual_uri12"}}]->(ResearchObjectiveTopic_ind)
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(ResearchActivityTopic_ind:orkg_ResearchActivityTopic_IND:orkg_Topic_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research activity topic unit", description:"This topic models all data of a particular research activity as it is documented in a particular research paper.", URI:"{topic_uri}", topic_URI:"{topic_uri}", type:"ResearchActivity_topic_class_URI", node_type:"topic", category:"NamedIndividual", entry_URI:"{entryURI}", KGBB_URI:"ResearchActivityTopicKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], topic_label:"$_input_name_$ [$_ontology_ID_$]"}})

    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:"topic_URI:parent_data_item_node.URI", assertion_URI:"new_individual_uri2"}}]->(researchActivityParthoodAssertion_ind:orkg_ResearchActivityParthoodAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"orkg research activity parthood assertion", description:"This assertion models the relation between a particular research activity and one its activity parts (i.e., research steps).", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Activity_Parthood_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchActivityParthoodAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research activity parthood"}})

    CREATE (researchActivityParthoodAssertion_ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchActivityParthoodAssertion_ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchActivityTopic_ind)
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchMethodActivityAssertion_Ind:orkg_ResearchMethodActivityRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research method activity relation assertion unit", description:"This assertion models the relation between a particular research method and the activity that realizes it.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Method_Activity_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchMethodActivityRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research method activity"}})

    CREATE (researchMethodActivityAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchMethodActivityAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchActivityTopic_ind)
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchResultActivityRelationAssertion_Ind:orkg_ResearchResultActivityRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research result activity relation assertion unit", description:"This assertion models the relation between a particular research result and the research activity that has it as its output.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Result_Activity_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchResultActivityRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research result activity"}})

    CREATE (researchResultActivityRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchResultActivityRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchActivityTopic_ind)

    CREATE (ResearchActivityTopic_ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(ResearchActivity)',  from_objective_cypher_code:'MATCH (parent_data_item_node {{URI:"parent_data_item_uri"}})
    WITH parent_data_item_node MATCH (object_node) WHERE object_node.URI=parent_data_item_node.object_URI SET object_node.data_node_type=object_node.data_node_type + "topic_object"
    WITH object_node, parent_data_item_node MATCH (entry_node {{URI:"{entryURI}"}}) SET entry_node.last_updated_on = localdatetime()
    WITH object_node, parent_data_item_node, entry_node
    ...
    CREATE (ResearchActivity:ResearchActivity_ind:orkg_ResearchActivity_IND:obi_Investigation_IND:obi_PlannedProcess_IND:bfo_Process_IND:NamedIndividual:Entity {{URI:"new_individual_uri1", type:"$_input_type_$", name:"$_input_name_$", instance_label:"$_input_name_$", ontology_ID:"$_ontology_ID_$", description:"$_input_description_$", data_node_type:["topic_object", "input1"], current_version:"true", entry_URI:"{entryURI}", topic_URI:["{topic_uri}"], created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], category:"NamedIndividual", data_view_information:"true", input:"true", input_source:"input1", input_version_ID:0, inputVariable:1, input_info_URI:"InputInfo1ResearchActivityTopicIND_URI", user_input:"{topic_uri}"}})-[:ACHIEVES_PLANNED_OBJECTIVE {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/OBI_0000417", entry_URI:"{entryURI}", topic_URI:"{topic_uri}", description:"This relation obtains between a planned process and a objective specification when the criteria specified in the objective specification are met at the end of the planned process."}}]->(object_node)

    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(ResearchActivityTopic_ind:orkg_ResearchActivityTopic_IND:orkg_Topic_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research overview topic unit", description:"This topic models all data of a particular research activity as it is documented in a particular research paper.", URI:"{topic_uri}", topic_URI:"{topic_uri}", type:"ResearchActivity_topic_class_URI", node_type:"topic", category:"NamedIndividual", entry_URI:"{entryURI}", KGBB_URI:"ResearchActivityTopicKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], topic_label:"$_input_name_$ [$_ontology_ID_$]"}})

    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchObjectiveActivityRelationAssertion_Ind:orkg_ResearchObjectiveActivityRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research objective activity relation assertion unit", description:"This assertion models the relation between a particular research objective and the research activity that achieves it.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Objective_Activity_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchObjectiveActivityRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research objective activity"}})

    CREATE (researchObjectiveActivityRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchObjectiveActivityRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchActivityTopic_ind)
    ...
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(researchActivityTopic_ind:orkg_ResearchActivityTopic_IND {{URI:"$_input_uri_$", current_version:"true"}}) SET researchActivityTopic_ind.last_updated_on = localdatetime(), researchActivityTopic_ind.object_URI = "new_individual_uri1"
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(ResearchObjectiveTopic_ind:orkg_ResearchObjectiveTopic_IND {{URI:"$_input_uri_$", current_version:"true"}}) SET ResearchObjectiveTopic_ind.last_updated_on = localdatetime(), ResearchObjectiveTopic_ind.object_URI = "new_individual_uri1"
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchActivityObjetiveRelationAssertion_Ind:orkg_ResearchActivityObjectiveRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research activity objective relation assertion unit", description:"This assertion unit models the relation between a particular research activity and one of the research objectives it achieves.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", topic_URI:parent_data_item_node.URI, type:"Research_Activity_Objective_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", KGBB_URI:"ResearchActivityObjectiveRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research activity objective"}})

    CREATE (researchActivityObjetiveRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchActivityObjetiveRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchObjectiveTopic_ind)
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchMethodObjectiveRelationAssertion_Ind:orkg_ResearchMethodObjectiveRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research method objective relation assertion unit", description:"This assertion models the relation between a particular research method and its objective specification part.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Method_Objective_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchMethodObjectiveRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research method objective"}})

    CREATE (researchMethodObjectiveRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchMethodObjectiveRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchObjectiveTopic_ind)

    CREATE (ResearchObjectiveTopic_ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(researchObjective)', from_result_cypher_code:'MATCH (entry_node {{URI:"{entryURI}"}}) SET entry_node.last_updated_on = localdatetime()
    WITH entry_node
    FOREACH (i IN CASE WHEN NOT "{creator}" IN entry_node.contributed_by THEN [1] ELSE [] END |
    SET entry_node.contributed_by = entry_node.contributed_by + "{creator}"
    )
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchResultObjectiveRelationAssertion_Ind:orkg_ResearchResultObjectiveRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research result objective relation assertion unit", description:"This assertion models the relation between a particular research result and the research objective that achieved it.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Result_Objective_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchResultObjectiveRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research result objective"}})

    CREATE (researchResultObjectiveRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchResultObjectiveRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchObjectiveTopic_ind)
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_dcontains_uri", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(ResearchObjectiveTopic_ind:orkg_ResearchObjectiveTopic_IND:orkg_Topic_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research objective topic unit", description:"This topic models a research objective documented in a particular research paper.", URI:"{topic_uri}", topic_URI:"{topic_uri}", type:"ResearchObjective_topic_class_URI", node_type:"topic", category:"NamedIndividual", entry_URI:"{entryURI}", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], topic_label:"$_input_name_$ [$_ontology_ID_$]"}})

    CREATE (object_node)-[:HAS_PART {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/BFO_0000051", entry_URI:"{entryURI}", topic_URI:"{topic_uri}", description:"a core relation that holds between a whole and its part."}}]->(researchObjective:orkg_ResearchObjective_IND:iao_ObjectiveSpecification_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{URI:"new_individual_uri1", type:"$_input_type_$", name:"$_input_name_$", instance_label:"$_input_name_$", ontology_ID:"$_ontology_ID_$", description:"$_input_description_$", data_node_type:["topic_object", "input1"], current_version:"true", entry_URI:"{entryURI}", topic_URI:["{topic_uri}"], created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], category:"NamedIndividual", data_view_information:"true", input:"true", input_source:"input1", input_version_ID:0, inputVariable:1, input_info_URI:"InputInfo1ResearchObjectiveTopicIND_URI", user_input:"{topic_uri}"}})

    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchObjectiveParthoodAssertion_Ind:orkg_ResearchObjectiveParthoodAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research objective parthood assertion unit", description:"This assertion unit models the relation between a particular research objective and its objective parts.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Objective_Parthood_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchObjectiveParthoodAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research objective parthood"}})

    CREATE (researchObjectiveParthoodAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchObjectiveParthoodAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchObjectiveTopic_ind)
    ...
    CREATE (object_node)-[:HAS_PART {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/BFO_0000051", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(researchResult:orkg_ResearchResult_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{URI:"new_individual_uri1", type:"$_input_type_$", name:"$_input_name_$", instance_label:"$_input_name_$", ontology_ID:"$_ontology_ID_$", description:"$_input_description_$", data_node_type:["topic_object", "input1"], current_version:"true", entry_URI:"{entryURI}", topic_URI:["{topic_uri}"], created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], category:"NamedIndividual", data_view_information:"true", input:"true", input_source:"input1", input_version_ID:0, inputVariable:1, input_info_URI:"InputInfo1ResearchResultTopicIND_URI", user_input:"{topic_uri}"}})

    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchResultParthoodAssertion_Ind:orkg_ResearchResultParthoodAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research result parthood assertion unit", description:"This assertion unit models the relation between a particular research result and one of its research result parts.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Activity_Parthood_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchResultParthoodAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research result parthood"}})

    CREATE (researchResultParthoodAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchResultParthoodAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchResultTopic_ind)

    CREATE (ResearchResultTopic_ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(researchResult)', from_objective_cypher_code:'MATCH (parent_data_item_node {{URI:"parent_data_item_uri"}})
    WITH parent_data_item_node MATCH (object_node) WHERE object_node.URI=parent_data_item_node.object_URI SET object_node.data_node_type=object_node.data_node_type + "topic_object"
    WITH object_node, parent_data_item_node MATCH (entry_node {{URI:"{entryURI}"}}) SET entry_node.last_updated_on = localdatetime()
    WITH object_node, parent_data_item_node, entry_node
    FOREACH (i IN CASE WHEN NOT "{creator}" IN entry_node.contributed_by THEN [1] ELSE [] END |
    ...
    CREATE (object_node)-[:HAS_ACHIEVED_RESULT {{category:"ObjectPropertyExpression", URI:"http://orkg_has_achieved_result", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(researchResult:orkg_ResearchResult_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{URI:"new_individual_uri1", type:"$_input_type_$", name:"$_input_name_$", instance_label:"$_input_name_$", ontology_ID:"$_ontology_ID_$", description:"$_input_description_$", data_node_type:["topic_object", "input1"], current_version:"true", entry_URI:"{entryURI}", topic_URI:["{topic_uri}"], created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], category:"NamedIndividual", data_view_information:"true", input:"true", input_source:"input1", input_version_ID:0, inputVariable:1, input_info_URI:"InputInfo1ResearchResultTopicIND_URI", user_input:"{topic_uri}"}})

    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchObjectiveResultRelationAssertion_Ind:orkg_ResearchObjectiveResultRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research objective result relation assertion unit", description:"This assertion models the relation between a particular research objective and the research result that it achieved.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Objective_Result_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchObjectiveResultRealtionAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research objective result"}})

    CREATE (researchObjectiveResultRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchObjectiveResultRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchResultTopic_ind)
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(ResearchResultTopic_ind:orkg_ResearchResultTopic_IND {{URI:"$_input_uri_$", current_version:"true"}}) SET ResearchResultTopic_ind.last_updated_on = localdatetime(), ResearchResultTopic_ind.object_URI = "new_individual_uri1"
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(ResearchResultTopic_ind:orkg_ResearchResultTopic_IND {{URI:"{topic_uri}", current_version:"true"}}) SET ResearchResultTopic_ind.last_updated_on = localdatetime(), ResearchResultTopic_ind.topic_label = "$_input_name_$ [$_ontology_ID_$]", ResearchResultTopic_ind.object_URI = "new_individual_uri1"
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchActivityOutputAssertion_Ind:orkg_ResearchActivityOutputRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research activity output relation assertion unit", description:"This assertion unit models the relation between a particular research activity and one of its research result outputs.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Activity_Output_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchActivityOutputRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research activity output"}})

    CREATE (object_node)-[:HAS_SPECIFIED_OUTPUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/OBI_0000299", entry_URI:"{entryURI}", topic_URI:"{topic_uri}", description:"A relation between a planned process and a continuant participating in that process. The presence of the continuant at the end of the process is explicitly specified in the objective specification which the process realizes the concretization of."}}]->(researchResult:orkg_ResearchResult_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{URI:"new_individual_uri1", type:"$_input_type_$", name:"$_input_name_$", instance_label:"$_input_name_$", ontology_ID:"$_ontology_ID_$", description:"$_input_description_$", data_node_type:["topic_object", "input1"], current_version:"true", entry_URI:"{entryURI}", topic_URI:["{topic_uri}"], created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], category:"NamedIndividual", data_view_information:"true", input:"true", input_source:"input1", input_version_ID:0, inputVariable:1, input_info_URI:"InputInfo1ResearchResultTopicIND_URI", user_input:"{topic_uri}"}})

    CREATE (researchActivityOutputAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchResult)

    CREATE (researchActivityOutputAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchResultTopic_ind)

    CREATE (ResearchResultTopic_ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(object_node)
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(ResearchMethodTopic_ind:orkg_ResearchMethodTopic_IND {{URI:"$_input_uri_$", current_version:"true"}}) SET ResearchMethodTopic_ind.last_updated_on = localdatetime(), ResearchMethodTopic_ind.object_URI = "new_individual_uri1"
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(ResearchMethodTopic_ind:orkg_ResearchMethodTopic_IND {{URI:"{topic_uri}", current_version:"true"}}) SET ResearchMethodTopic_ind.last_updated_on = localdatetime(), ResearchMethodTopic_ind.topic_label = "$_input_name_$ [$_ontology_ID_$]", ResearchMethodTopic_ind.object_URI = "new_individual_uri1"
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchActivityMethodAssertion_Ind:orkg_ResearchActivityMethodRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research activity method relation assertion unit", description:"This assertion unit models the relation between a particular research activity and one of the research methods it realizes.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Activity_Method_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchActivityMethodRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research activity method"}})

    CREATE (researchActivityMethodAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchActivityMethodAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchMethodTopic_ind)

    CREATE (object_node)-[:REALIZES {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/BFO_0000055", entry_URI:"{entryURI}", topic_URI:"{topic_uri}", description:"to say that b realizes c at t is to assert that there is some material entity d & b is a process which has participant d at t & c is a disposition or role of which d is bearer_of at t& the type instantiated by b is correlated with the type instantiated by c. (axiom label in BFO2 Reference: [059-003])."}}]->(researchMethod:orkg_ResearchMethod_IND:iao_PlanSpecification_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{URI:"new_individual_uri1", type:"$_input_type_$", name:"$_input_name_$", instance_label:"$_input_name_$", ontology_ID:"$_ontology_ID_$", description:"$_input_description_$", data_node_type:["topic_object", "input1"], current_version:"true", entry_URI:"{entryURI}", topic_URI:["{topic_uri}"], created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], category:"NamedIndividual", data_view_information:"true", input:"true", input_source:"input1", input_version_ID:0, inputVariable:1, input_info_URI:"InputInfo1ResearchMethodTopicIND_URI", user_input:"{topic_uri}"}})

    CREATE (ResearchMethodTopic_ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:"{topic_uri}"}}]->(researchMethod)', from_objective_cypher_code:'MATCH (entry_node {{URI:"{entryURI}"}}) SET entry_node.last_updated_on = localdatetime()
    WITH entry_node
    FOREACH (i IN CASE WHEN NOT "{creator}" IN entry_node.contributed_by THEN [1] ELSE [] END |
    SET entry_node.contributed_by = entry_node.contributed_by + "{creator}"
    )
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchObjectiveMethodRelationAssertion_Ind:orkg_ResearchObjectiveMethodRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research objective method relation assertion unit", description:"This assertion models the relation between a particular research objective and a research method of which it is a part.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Objective_Method_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchObjectiveMethodRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research objective method"}})

    CREATE (researchObjectiveMethodRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchObjectiveMethodRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchMethodTopic_ind)

    CREATE (researchMethod:orkg_ResearchMethod_IND:iao_PlanSpecification_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{URI:"new_individual_uri1", type:"$_input_type_$", name:"$_input_name_$", instance_label:"$_input_name_$", ontology_ID:"$_ontology_ID_$", description:"$_input_description_$", data_node_type:["topic_object", "input1"], current_version:"true", entry_URI:"{entryURI}", topic_URI:["{topic_uri}"], created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], category:"NamedIndividual", data_view_information:"true", input:"true", input_source:"input1", input_version_ID:0, inputVariable:1, input_info_URI:"InputInfo1ResearchMethodTopicIND_URI", user_input:"{topic_uri}"}})-[:HAS_PART {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/BFO_0000051", entry_URI:"{entryURI}", topic_URI:"{topic_uri}", description:"a core relation that holds between a whole and its part."}}]->(object_node)
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchMethodParthoodAssertion_Ind:orkg_ResearchMethodParthoodAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research method parthood assertion unit", description:"This assertion unit models the relation between a particular research method and one of its method parts (i.e. steps).", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Method_Parthood_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchMethodParthoodAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research method parthood"}})

    CREATE (researchMethodParthoodAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchMethodParthoodAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(ResearchMethodTopic_ind)
    ...
    CREATE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(researchResultMaterialEntityRelationAssertion_Ind:orkg_ResearchResultMaterialEntityRelationAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"research result material entity relation assertion unit", description:"This assertion models the relation between a particular research result and a material entity that it is about.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Research_Result_Material_Entity_Relation_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"ResearchResultMaterialEntityRelationAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Research result material entity"}})

    CREATE (researchResultMaterialEntityRelationAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    CREATE (researchResultMaterialEntityRelationAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(material_entityTopic_ind)
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(material_entityTopic_ind:orkg_MaterialEntityTopic_IND {{URI:"$_input_uri_$", current_version:"true"}}) SET material_entityTopic_ind.last_updated_on = localdatetime(), material_entityTopic_ind.object_URI = "new_individual_uri1"
    ...
    OPTIONAL MATCH (root_topic:orkg_MaterialEntityTopic_IND {{current_version:"true"}})-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(parent_data_item_node)
    ...
    MERGE (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT {{category:"ObjectPropertyExpression", URI:"orkg_contains_uri", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(materialEntityParthoodAssertion_Ind:orkg_MaterialEntityParthoodAssertion_IND:orkg_Assertion_IND:iao_DocumentPart_IND:iao_InformationContentEntity_IND:NamedIndividual:Entity {{name:"material entity parthood assertion unit", description:"This assertion models the relation between a particular material entity and its material entity parts.", URI:"new_individual_uri2", assertion_URI:"new_individual_uri2", type:"Material_Entity_Parthood_Assertion_URI", node_type:"assertion", category:"NamedIndividual", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, KGBB_URI:"MaterialEntityParthoodAssertionKGBB_URI", object_URI:"new_individual_uri1", created_on:localdatetime(), last_updated_on:localdatetime(), created_by:"{creator}", contributed_by:["{creator}"], created_with:"{createdWith}", current_version:"true", versioned_doi:["NULL"], dataset_doi:["NULL"], assertion_label:"Material entity parthood"}})

    MERGE (materialEntityParthoodAssertion_Ind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(object_node)

    MERGE (materialEntityParthoodAssertion_Ind)-[:DESCRIBED_BY {{category:"ObjectPropertyExpression", URI:"http://orkg?????5", entry_URI:"{entryURI}", topic_URI:parent_data_item_node.URI, assertion_URI:"new_individual_uri2"}}]->(material_entityTopic_ind)
    ...
    //RESEARCH ACTIVITY OUTPUT RELATION ASSERTION KGBB
    CREATE (researchActivityOutputAssertionkgbb:ResearchActivityOuputRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research activity output relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research activities and their research result outputs.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000299"], relevant_classes_URI:["http://orkg???????1", "http://orkg???????5"], URI:"ResearchActivityOutputRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH ACTIVITY METHOD RELATION ASSERTION KGBB
    CREATE (researchActivityMethodAssertionkgbb:ResearchActivityMethodRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research activity method relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research activities and the research methods they realize.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000055"], relevant_classes_URI:["http://orkg???????5", "http://orkg???????4"], URI:"ResearchActivityMethodRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH ACTIVITY OBJECTIVE RELATION ASSERTION KGBB
    CREATE (researchActivityObjectiveAssertionkgbb:ResearchActivityObjectiveRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research activity objective relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research activities and the research objective they achieve.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000417"], relevant_classes_URI:["http://orkg???????5", "http://orkg???????3"], URI:"ResearchActivityObjectiveRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH ACTIVITY PARTHOOD ASSERTION KGBB
    CREATE (researchActivityParthoodAssertionkgbb:ResearchActivityParthoodRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research activity parthood assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research activities and their activity parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000117"], relevant_classes_URI:["http://orkg???????5"], URI:"ResearchActivityParthoodAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH METHOD PARTHOOD ASSERTION KGBB
    CREATE (researchMethodParthoodAssertionkgbb:ResearchMethodParthoodRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research method parthood assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research methods and their method parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????4"], URI:"ResearchMethodParthoodAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH METHOD OBJECTIVE RELATION ASSERTION KGBB
    CREATE (researchMethodObjectiveRelationAssertionkgbb:ResearchMethodObjectiveRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research method objective relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research methods and their research objective parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????4", "http://orkg???????3"], URI:"ResearchMethodObjectiveRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH METHOD ACTIVITY RELATION ASSERTION KGBB
    CREATE (researchMethodActivityRelationAssertionkgbb:ResearchMethodActivityRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research method activity relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research methods and the research activities that realize them.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000055"], relevant_classes_URI:["http://orkg???????4", "http://orkg???????5"], URI:"ResearchMethodActivityRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH RESULT PARTHOOD ASSERTION KGBB
    CREATE (researchResultParthoodAssertionkgbb:ResearchResultParthoodRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research result parthood assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research results and their result parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????1"], URI:"ResearchResultParthoodAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH RESULT ACTIVITY RELATION ASSERTION KGBB
    CREATE (researchResultActivityRelationAssertionkgbb:ResearchResultActivityRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research result activity relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research results and the research activities that have them as their output.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000299"], relevant_classes_URI:["http://orkg???????1", "http://orkg???????5"], URI:"ResearchResultActivityRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH RESULT OBJECTIVE RELATION ASSERTION KGBB
    CREATE (researchResultObjectiveRelationAssertionkgbb:ResearchResultObjectiveRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research result objective relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research results and the research objectives that achieved them.", relevant_properties_URI:["http://orkg_has_achieved_result"], relevant_classes_URI:["http://orkg???????1", "http://orkg???????3"], URI:"ResearchResultObjectiveRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH OBJECTIVE PARTHOOD ASSERTION KGBB
    CREATE (researchObjectiveParthoodAssertionkgbb:ResearchObjectiveParthoodRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research objective parthood assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research objectives and their objective parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????3"], URI:"ResearchObjectiveParthoodAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH OBJECTIVE METHOD RELATION ASSERTION KGBB
    CREATE (researchObjectiveMethodRelationAssertionkgbb:ResearchObjectiveMethodRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research objective method relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research objectives and the research methods they are part of.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://orkg???????3", "http://orkg???????4"], URI:"ResearchObjectiveMethodRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH OBJECTIVE ACTIVITY RELATION ASSERTION KGBB
    CREATE (researchObjectiveActivityRelationAssertionkgbb:ResearchObjectiveActivityRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research objective activity relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research objectives and the reseach activities that achieve them.", relevant_properties_URI:["http://purl.obolibrary.org/obo/OBI_0000417"], relevant_classes_URI:["http://orkg???????5", "http://orkg???????4"], URI:"ResearchObjectiveActivityRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH OBJECTIVE RESULT RELATION ASSERTION KGBB
    CREATE (researchObjectiveResultRelationAssertionkgbb:ResearchObjectiveResultRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research objective result relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research objectives and the reseach results they achieved.", relevant_properties_URI:["http://orkg_has_achieved_result"], relevant_classes_URI:["http://orkg???????3", "http://orkg???????1"], URI:"ResearchObjectiveResultRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //MATERIAL ENTITY PARTHOOD ASSERTION KGBB
    CREATE (materialEntityParthoodAssertionkgbb:MaterialEntityParthoodRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"material entity parthood assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between material entities and their material entity parts.", relevant_properties_URI:["http://purl.obolibrary.org/obo/BFO_0000051"], relevant_classes_URI:["http://purl.obolibrary.org/obo/BFO_0000040"], URI:"MaterialEntityParthoodAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    //RESEARCH RESULT MATERIAL ENTITY RELATION ASSERTION KGBB
    CREATE (researchResultMaterialEntityRelationAssertionkgbb:ResearchResultMaterialEntityRelationAssertionKGBB:AssertionKGBB:KGBB:ClassExpression:Entity {{name:"research result material entity relation assertion Knowledge Graph Building Block", description:"A Knowledge Graph Building Block that manages relations between research results and the material entities they are about.", relevant_properties_URI:["http://purl.obolibrary.org/obo/IAO_0000136"], relevant_classes_URI:["http://orkg???????1", "http://purl.obolibrary.org/obo/BFO_0000040"], URI:"ResearchResultMaterialEntityRelationAssertionKGBB_URI", category:"ClassExpression", operational_KGBB:"true", quality_cypher_code:'cypherQuery', search_cypher_code:"cypherQuery", data_item_type:"assertion"}})-[:SUBCLASS_OF {{category:"ObjectPropertyExpression", URI:"http://www.w3.org/2000/01/rdf-schema#subClassOf"}}]->(assertionKGBB)
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(QualityAssertionind:orkg_QualityRelationIdentificationAssertion_IND {{URI:"$_input_uri_$", current_version:"true"}}) SET QualityAssertionind.last_updated_on = localdatetime(), QualityAssertionind.object_URI = "new_individual_uri1"
    ...
    CREATE (researchTopicAssertionind)-[:IS_ABOUT {{category:"ObjectPropertyExpression", URI:"http://purl.obolibrary.org/obo/IAO_0000136", entry_URI:"{entryURI}", assertion_URI:"{assertionURI}"}}]->(object_node)', label_cypher:'MATCH (entry_node {{URI:"{entryURI}"}}) SET entry_node.last_updated_on = localdatetime()
    WITH entry_node
    FOREACH (i IN CASE WHEN NOT "{creator}" IN entry_node.contributed_by THEN [1] ELSE [] END |
    SET entry_node.contributed_by = entry_node.contributed_by + "{creator}"
    )
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(researchTopicAssertionind:orkg_ResearchTopicAssertion_IND {{URI:"$_input_uri_$", current_version:"true"}}) SET researchTopicAssertionind.last_updated_on = localdatetime()
    ...
    WITH parent_data_item_node, object_node, researchTopicAssertionind
    MATCH (object_node)-[:HAS_TOPIC]->(topic_old:orkg_orkg_ResearchTopic_IND {{current_version:"true", assertion_URI:researchTopicAssertionind.URI}})
    ...
    MATCH (object_node)-[:HAS_TOPIC]->(topic_new:orkg_orkg_ResearchTopic_IND {{current_version:"true", assertion_URI:researchTopicAssertionind.URI}})
    ...
    WITH parent_data_item_node, object_node
    MATCH (parent_data_item_node)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(researchTopicAssertionind:orkg_ResearchTopicAssertion_IND {{URI:"{assertionURI}", current_version:"true"}}) SET researchTopicAssertionind.last_updated_on = localdatetime(), researchTopicAssertionind.assertion_label = "$_input_name_$ [$_ontology_ID_$]"
    ...
    YIELD input, output
    WITH parent_data_item_node, object_node, researchTopicAssertionind, topic_old SET topic_old.current_version = "false"
    WITH object_node, researchTopicAssertionind
    MATCH (object_node)-[:HAS_TOPIC]->(topic_new:orkg_orkg_ResearchTopic_IND {{current_version:"true", assertion_URI:researchTopicAssertionind.URI}})
    ...
    CREATE (ResearchActivityTopickgbb)-[:HAS_DATA_REPRESENTATION {{category:"ObjectPropertyExpression", URI:"orkg_has_data_representation_URI"}}]->(researchActivityTopicRepresentation1KGBBelement:ResearchActivityTopicRepresentationKGBBElement_IND:TopicRepresentationKGBBElement_IND:RepresentationKGBBElement_IND:KGBBElement_IND:NamedIndividual:Entity {{name:"Research activity topic representation element", description:"A Knowledge Graph Building Block element that provides information for the front end for representing research activity data associated with a research paper entry in the user interface in a human-readable form using the research activity topic Knowledge Graph Building Block.", data_view_name:"{data_view_name}", node_type:"topic representation", URI:"ResearchActivityTopicRepresentation1KGBBElementIND_URI", data_item_type_URI:"ResearchActivity_topic_class_URI",  type:"TopicRepresentationKGBBElement_URI", KGBB_URI:"ResearchActivityTopicKGBB_URI", category:"NamedIndividual", data_view_information:"true", topic_html:"research_overview.html", component:"research_activity_topic", link_$$$_1:"{{'name':'research_step_topic_input_info', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/OBI_0000011', 'ontology_ID':'OBI', 'target_KGBB_URI':'ResearchActivityTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchActivityParthoodAssertionKGBB_URI', 'data_item_type':'topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic', 'edit_results_in':'edited_topic', 'links_to_component':'research_activity_topic', 'query_key':'from_activity_cypher_code', 'edit_cypher_key':'edit_cypher', 'placeholder_text':'specify the type of research activity', 'input_info_URI':'InputInfo1ResearchActivityTopicIND_URI', 'input_source':'input1', 'editable':'true'}}",
    link_$$$_2:"{{'name':'research_result_topic_input_info', 'placeholder_text':'specify the type of research result', 'ontology_ID':'IAO', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/IAO_0000030', 'target_KGBB_URI':'ResearchResultTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchActivityOutputRelationAssertionKGBB_URI', 'data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_activity_cypher_code', 'links_to_component':'research_result_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}", link_$$$_3:"{{'name':'research_method_topic_input_info', 'placeholder_text':'specify the type of research method', 'ontology_ID':'MMO,NCIT', 'input_restricted_to_subclasses_of':'', 'target_KGBB_URI':'ResearchMethodTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchActivityMethodRelationAssertionKGBB_URI', 'data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_activity_cypher_code', 'links_to_component':'research_method_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}", link_$$$_4:"{{'name':'research_objective_topic_input_info', 'placeholder_text':'specify the type of research objective', 'ontology_ID':'AGRO,IAO,ERO,OBI', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/IAO_0000005', 'target_KGBB_URI':'ResearchObjectiveTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchActivityObjectiveRelationAssertionKGBB_URI', 'data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_activity_cypher_code', 'links_to_component':'research_objective_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}"}})
    ...
    CREATE (ResearchActivityTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research activity step of a research activity.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchActivityTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_activity_cypher_code", instantiated_by_assertionKGBB:"ResearchActivityParthoodAssertionKGBB_URI"}}]->(ResearchActivityTopickgbb)

    CREATE (ResearchActivityTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research activity parthood assertions in its entry.", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchActivityParthoodAssertionKGBB_URI", required:"false", quantity:"m", query_key:"from_activity_cypher_code", assertion_object_URI:"object$_$URI", input_results_in:"added_assertion", instantiates_topicKGBB:"ResearchActivityTopicKGBB_URI"}}]->(researchActivityParthoodAssertionkgbb)

    CREATE (ResearchActivityTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research result of a research activity.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchResultTopicKGBB_URI", required:"true", input_results_in:"added_topic", quantity:"m", query_key:"from_activity_cypher_code", instantiated_by_assertionKGBB:"ResearchActivityOutputRelationAssertionKGBB_URI"}}]->(ResearchResultTopickgbb)

    CREATE (ResearchActivityTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research activity output relation assertions in its entry.", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchActivityOutputRelationAssertionKGBB_URI", required:"false", quantity:"m", query_key:"from_activity_cypher_code", assertion_object_URI:"object$_$URI", input_results_in:"added_assertion", instantiates_topicKGBB:"ResearchResultTopicKGBB_URI"}}]->(researchActivityOutputAssertionkgbb)

    CREATE (ResearchActivityTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research method realized in a research activity.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchMethodTopicKGBB_URI", required:"true", input_results_in:"added_topic", quantity:"m", query_key:"from_activity_cypher_code", instantiated_by_assertionKGBB:"ResearchActivityMethodRelationAssertionKGBB_URI"}}]->(ResearchMethodTopickgbb)

    CREATE (ResearchActivityTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research activity method relation assertions in its entry.", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchActivityMethodRelationAssertionKGBB_URI", required:"false", quantity:"m", query_key:"from_activity_cypher_code", assertion_object_URI:"object$_$URI", input_results_in:"added_assertion", instantiates_topicKGBB:"ResearchMethodTopicKGBB_URI"}}]->(researchActivityMethodAssertionkgbb)

    CREATE (ResearchActivityTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research objective achieved by a research activity.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveTopicKGBB_URI", required:"true", input_results_in:"added_topic", quantity:"m", query_key:"from_activity_cypher_code", instantiated_by_assertionKGBB:"ResearchActivityObjectiveRelationAssertionKGBB_URI"}}]->(ResearchObjectiveTopickgbb)

    CREATE (ResearchActivityTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research activity objective relation assertions in its entry.", KGBB_URI:"ResearchActivityTopicKGBB_URI", target_KGBB_URI:"ResearchActivityObjectiveRelationAssertionKGBB_URI", required:"false", quantity:"m", query_key:"from_activity_cypher_code", assertion_object_URI:"object$_$URI", input_results_in:"added_assertion", instantiates_topicKGBB:"ResearchObjectiveTopicKGBB_URI"}}]->(researchActivityObjectiveAssertionkgbb)
    ...
    CREATE (ResearchMethodTopickgbb)-[:HAS_DATA_REPRESENTATION {{category:"ObjectPropertyExpression", URI:"orkg_has_data_representation_URI"}}]->(researchMethodTopicRepresentation1KGBBelement:ResearchMethodTopicRepresentationKGBBElement_IND:TopicRepresentationKGBBElement_IND:RepresentationKGBBElement_IND:KGBBElement_IND:NamedIndividual:Entity {{name:"Research method topic representation element", description:"A Knowledge Graph Building Block element that provides information for the front end for representing research method data associated with a research paper entry in the user interface in a human-readable form using the research method topic Knowledge Graph Building Block.", data_view_name:"{data_view_name}", node_type:"topic representation", URI:"ResearchMethodTopicRepresentation1KGBBElementIND_URI", data_item_type_URI:"ResearchMethod_topic_class_URI",  type:"TopicRepresentationKGBBElement_URI", KGBB_URI:"ResearchMethodTopicKGBB_URI", category:"NamedIndividual", data_view_information:"true", topic_html:"research_method.html", component:"research_method_topic", link_$$$_1:"{{'name':'research_step_topic_input_info', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/OBI_0000011', 'ontology_ID':'OBI', 'target_KGBB_URI':'ResearchActivityTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchMethodActivityRelationAssertionKGBB_URI', 'data_item_type':'topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic', 'edit_results_in':'edited_topic', 'links_to_component':'research_activity_topic', 'query_key':'from_method_cypher_code', 'edit_cypher_key':'edit_cypher', 'placeholder_text':'specify the type of research activity', 'input_info_URI':'InputInfo1ResearchActivityTopicIND_URI', 'input_source':'input1', 'editable':'true'}}",
    link_$$$_2:"{{'name':'research_method_topic_input_info', 'placeholder_text':'specify the type of research method', 'ontology_ID':'MMO,NCIT', 'input_restricted_to_subclasses_of':'', 'target_KGBB_URI':'ResearchMethodTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchMethodParthoodAssertionKGBB_URI','data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_method_cypher_code', 'links_to_component':'research_method_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}", link_$$$_3:"{{'name':'research_objective_topic_input_info', 'placeholder_text':'specify the type of research objective', 'ontology_ID':'AGRO,IAO,ERO,OBI', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/IAO_0000005', 'target_KGBB_URI':'ResearchObjectiveTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchMethodObjectiveRelationAssertionKGBB_URI', 'data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_method_cypher_code', 'links_to_component':'research_objective_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}"}})
    ...
    CREATE (ResearchMethodTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a step of the research method.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchMethodTopicKGBB_URI", target_KGBB_URI:"ResearchMethodTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_method_cypher_code", instantiated_by_assertionKGBB:"ResearchMethodParthoodAssertionKGBB_URI"}}]->(ResearchMethodTopickgbb)

    CREATE (ResearchMethodTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research method parthood assertions in its entry.", KGBB_URI:"ResearchMethodTopicKGBB_URI", target_KGBB_URI:"ResearchMethodParthoodAssertionKGBB_URI", required:"false", quantity:"m", query_key:"from_method_cypher_code", assertion_object_URI:"object$_$URI", input_results_in:"added_assertion", instantiates_topicKGBB:"ResearchMethodTopicKGBB_URI"}}]->(researchMethodParthoodAssertionkgbb)

    CREATE (ResearchMethodTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research activity that realizes the research method.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchMethodTopicKGBB_URI", target_KGBB_URI:"ResearchActivityTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_method_cypher_code", instantiated_by_assertionKGBB:"ResearchMethodActivityRelationAssertionKGBB_URI"}}]->(ResearchActivityTopickgbb)

    CREATE (ResearchMethodTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research method activity relation assertions in its entry.", KGBB_URI:"ResearchMethodTopicKGBB_URI", target_KGBB_URI:"ResearchMethodActivityRelationAssertionKGBB_URI", required:"false", quantity:"m", query_key:"from_method_cypher_code", assertion_object_URI:"object$_$URI", input_results_in:"added_assertion", instantiates_topicKGBB:"ResearchActivityTopicKGBB_URI"}}]->(researchMethodActivityRelationAssertionkgbb)

    CREATE (ResearchMethodTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research objective that is part of the research method.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchMethodTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_method_cypher_code", instantiated_by_assertionKGBB:"ResearchMethodObjectiveRelationAssertionKGBB_URI"}}]->(ResearchObjectiveTopickgbb)

    CREATE (ResearchMethodTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research method objective relation assertions in its entry.", KGBB_URI:"ResearchMethodTopicKGBB_URI", target_KGBB_URI:"ResearchMethodObjectiveRelationAssertionKGBB_URI", required:"false", quantity:"m", query_key:"from_method_cypher_code", assertion_object_URI:"object$_$URI", input_results_in:"added_assertion", instantiates_topicKGBB:"ResearchObjectiveTopicKGBB_URI"}}]->(researchMethodObjectiveRelationAssertionkgbb)
    ...
    CREATE (ResearchObjectiveTopickgbb)-[:HAS_DATA_REPRESENTATION {{category:"ObjectPropertyExpression", URI:"orkg_has_data_representation_URI"}}]->(researchObjectiveTopicRepresentation1KGBBelement:ResearchObjectiveTopicRepresentationKGBBElement_IND:TopicRepresentationKGBBElement_IND:RepresentationKGBBElement_IND:KGBBElement_IND:NamedIndividual:Entity {{name:"Research objective topic representation element", description:"A Knowledge Graph Building Block element that provides information for the front end for representing research objective data associated with a research paper entry in the user interface in a human-readable form using the research objective topic Knowledge Graph Building Block.", data_view_name:"{data_view_name}", node_type:"topic representation", URI:"ResearchObjectiveTopicRepresentation1KGBBElementIND_URI", data_item_type_URI:"ResearchObjective_topic_class_URI",  type:"TopicRepresentationKGBBElement_URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", category:"NamedIndividual", data_view_information:"true", topic_html:"research_objective.html", component:"research_objective_topic", link_$$$_1:"{{'name':'research_objective_topic_input_info', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/IAO_0000005', 'ontology_ID':'AGRO,IAO,ERO,OBI', 'target_KGBB_URI':'ResearchObjectiveTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchObjectiveParthoodAssertionKGBB_URI', 'data_item_type':'topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic', 'edit_results_in':'edited_topic', 'links_to_component':'research_objective_topic', 'query_key':'from_objective_cypher_code', 'edit_cypher_key':'edit_cypher', 'placeholder_text':'specify the type of research objective', 'input_info_URI':'InputInfo1ResearchObjectiveTopicIND_URI', 'input_source':'input1', 'editable':'true'}}",
    link_$$$_2:"{{'name':'research_method_topic_input_info', 'placeholder_text':'specify the type of research method', 'ontology_ID':'MMO,NCIT', 'input_restricted_to_subclasses_of':'', 'target_KGBB_URI':'ResearchMethodTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchObjectiveMethodRelationAssertionKGBB_URI', 'data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_objective_cypher_code', 'links_to_component':'research_method_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}", link_$$$_3:"{{'name':'research_step_topic_input_info', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/OBI_0000011', 'ontology_ID':'OBI', 'target_KGBB_URI':'ResearchActivityTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchObjectiveActivityRelationAssertionKGBB_URI', 'data_item_type':'topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic', 'edit_results_in':'edited_topic', 'links_to_component':'research_activity_topic', 'query_key':'from_objective_cypher_code', 'edit_cypher_key':'edit_cypher', 'placeholder_text':'specify the type of research activity', 'input_info_URI':'InputInfo1ResearchActivityTopicIND_URI', 'input_source':'input1', 'editable':'true'}}", link_$$$_4:"{{'name':'research_result_topic_input_info', 'placeholder_text':'specify the type of research result', 'ontology_ID':'IAO', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/IAO_0000030', 'target_KGBB_URI':'ResearchResultTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchObjectiveResultRelationAssertionKGBB_URI', 'data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_objective_cypher_code', 'links_to_component':'research_result_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}"}})
    ...
    CREATE (ResearchObjectiveTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a the research method this research objective is a part of.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchMethodTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiated_by_assertionKGBB:"ResearchObjectiveMethodRelationAssertionKGBB_URI"}}]->(ResearchMethodTopickgbb)

    CREATE (ResearchObjectiveTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research objective method relation assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveMethodRelationAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiates_topicKGBB:"ResearchMethodTopicKGBB_URI"}}]->(researchObjectiveMethodRelationAssertionkgbb)

    CREATE (ResearchObjectiveTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research activity that achieves the research objective.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchActivityTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiated_by_assertionKGBB:"ResearchObjectiveActivityRelationAssertionKGBB_URI"}}]->(ResearchActivityTopickgbb)

    CREATE (ResearchObjectiveTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research objective activity relation assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveActivityRelationAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiates_topicKGBB:"ResearchActivityTopicKGBB_URI"}}]->(researchObjectiveActivityRelationAssertionkgbb)

    CREATE (ResearchObjectiveTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research result that achieves the research objective.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchResultTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiated_by_assertionKGBB:"ResearchObjectiveResultRelationAssertionKGBB_URI"}}]->(ResearchResultTopickgbb)

    CREATE (ResearchObjectiveTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research objective result relation assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveResultRelationAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiates_topicKGBB:"ResearchResultTopicKGBB_URI"}}]->(researchObjectiveResultRelationAssertionkgbb)

    CREATE (ResearchObjectiveTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research objective that is a part of this research objective.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiated_by_assertionKGBB:"ResearchObjectiveParthoodAssertionKGBB_URI"}}]->(ResearchObjectiveTopickgbb)

    CREATE (ResearchObjectiveTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research objective parthood assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchObjectiveTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveParthoodAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_objective_cypher_code", instantiates_topicKGBB:"ResearchObjectiveTopicKGBB_URI"}}]->(ResearchObjectiveTopickgbb)
    ...
    CREATE (ResearchResultTopickgbb)-[:HAS_DATA_REPRESENTATION {{category:"ObjectPropertyExpression", URI:"orkg_has_data_representation_URI"}}]->(researchResultTopicRepresentation1KGBBelement:ResearchResultTopicRepresentationKGBBElement_IND:TopicRepresentationKGBBElement_IND:RepresentationKGBBElement_IND:KGBBElement_IND:NamedIndividual:Entity {{name:"Research result topic representation element", description:"A Knowledge Graph Building Block element that provides information for the front end for representing research result data associated with a research paper entry in the user interface in a human-readable form using the research result topic Knowledge Graph Building Block.", data_item_type_URI:"ResearchResult_topic_class_URI", data_view_name:"{data_view_name}", node_type:"topic representation", URI:"ResearchResultTopicRepresentation1KGBBElementIND_URI", type:"TopicRepresentationKGBBElement_URI", KGBB_URI:"ResearchResultTopicKGBB_URI", category:"NamedIndividual", data_view_information:"true", topic_html:"research_result_topic.html",  component:"research_result_topic", link_$$$_1:"{{'name':'research_activity_topic_input_info', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/OBI_0000011', 'ontology_ID':'OBI', 'edit_results_in':'edited_topic', 'edit_cypher_key':'edit_cypher', 'target_KGBB_URI':'ResearchActivityTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchResultActivityRelationAssertionKGBB_URI', 'data_item_type':'topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic', 'links_to_component':'research_activity_topic', 'query_key':'from_result_cypher_code', 'placeholder_text':'specify the type of research activity', 'editable':'true'}}",
    link_$$$_2:"{{'name':'research_result_topic_input_info', 'placeholder_text':'specify the type of research result', 'ontology_ID':'IAO', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/IAO_0000030', 'target_KGBB_URI':'ResearchResultTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchResultParthoodAssertionKGBB_URI', 'input_info_URI':'InputInfo1ResearchResultTopicIND_URI', 'data_item_type':'topic', 'edit_results_in':'edited_topic', 'edit_cypher_key':'edit_cypher', 'query_key':'from_result_cypher_code', 'links_to_component':'research_result_topic', 'topic_object_URI':'object$_$URI', 'input_source':'input1', 'input_results_in':'added_topic'}}", link_$$$_3:"{{'name':'material_entity_topic_input_info', 'placeholder_text':'specify the type of material entity', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/BFO_0000040', 'edit_results_in':'edited_topic', 'edit_cypher_key':'edit_cypher', 'ontology_ID':'UBERON,OBI,IDO', 'target_KGBB_URI':'MaterialEntityTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchResultMaterialEntityRelationAssertionKGBB_URI', 'data_item_type':'topic', 'query_key':'from_result_cypher_code', 'links_to_component':'material_entity_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}", link_$$$_4:"{{'name':'research_objective_topic_input_info', 'placeholder_text':'specify the type of research objective', 'ontology_ID':'AGRO,IAO,ERO,OBI', 'input_restricted_to_subclasses_of':'http://purl.obolibrary.org/obo/IAO_0000005', 'target_KGBB_URI':'ResearchObjectiveTopicKGBB_URI', 'instantiated_by_assertionKGBB':'ResearchResultObjectiveRelationAssertionKGBB_URI', 'data_item_type':'topic', 'edit_cypher_key':'edit_cypher', 'edit_results_in':'edited_topic', 'query_key':'from_result_cypher_code', 'links_to_component':'research_objective_topic', 'topic_object_URI':'object$_$URI', 'input_results_in':'added_topic'}}"}})

    CREATE (ResearchResultTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research result documented in a particular research paper.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchResultTopicKGBB_URI", data_view_name:"{data_view_name}", target_KGBB_URI:"ResearchResultTopicKGBB_URI", required:"false", quantity:"m", query_key:"from_result_cypher_code", input_results_in:"added_topic", instantiated_by_assertionKGBB:"ResearchResultParthoodAssertionKGBB_URI"}}]->(ResearchResultTopickgbb)

    CREATE (ResearchResultTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research result parthood assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchResultTopicKGBB_URI", target_KGBB_URI:"ResearchResultParthoodAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_result_cypher_code", instantiates_topicKGBB:"ResearchResultTopicKGBB_URI"}}]->(researchResultParthoodAssertionkgbb)

    CREATE (ResearchResultTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research activity step of a research activity.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchResultTopicKGBB_URI", target_KGBB_URI:"ResearchActivityTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_result_cypher_code", instantiated_by_assertionKGBB:"ResearchResultActivityRelationAssertionKGBB_URI"}}]->(ResearchActivityTopickgbb)

    CREATE (ResearchResultTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research result activity relation assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchResultTopicKGBB_URI", target_KGBB_URI:"ResearchResultActivityRelationAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_result_cypher_code", instantiates_topicKGBB:"ResearchActivityTopicKGBB_URI"}}]->(researchResultActivityRelationAssertionkgbb)

    CREATE (ResearchResultTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a particular material entity as it is documented in a particular research paper.", topic_object_URI:"object$_$URI",KGBB_URI:"ResearchResultTopicKGBB_URI", data_view_name:"{data_view_name}", target_KGBB_URI:"MaterialEntityTopicKGBB_URI", required:"false", quantity:"m", query_key:"from_result_cypher_code", input_results_in:"added_topic", instantiated_by_assertionKGBB:"ResearchResultMaterialEntityRelationAssertionKGBB_URI"}}]->(materialEntityTopickgbb)

    CREATE (ResearchResultTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research result material entity relation assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchResultTopicKGBB_URI", target_KGBB_URI:"ResearchResultMaterialEntityRelationAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_result_cypher_code", instantiates_topicKGBB:"MaterialEntityTopicKGBB_URI"}}]->(researchResultMaterialEntityRelationAssertionkgbb)

    CREATE (ResearchResultTopickgbb)-[:HAS_TOPIC_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_topic_element_URI", description:"This topic element specifies information about a research objective that is part of the research method.", topic_object_URI:"object$_$URI", KGBB_URI:"ResearchResultTopicKGBB_URI", target_KGBB_URI:"ResearchObjectiveTopicKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_result_cypher_code", instantiated_by_assertionKGBB:"ResearchResultObjectiveRelationAssertionKGBB_URI"}}]->(ResearchObjectiveTopickgbb)

    CREATE (ResearchResultTopickgbb)-[:HAS_ASSERTION_ELEMENT {{category:"ObjectPropertyExpression", URI:"orkg_has_assertion_element_URI", description:"This assertion element specifies information about the use of research result objective relation assertions in its entry.", assertion_object_URI:"object$_$URI", KGBB_URI:"ResearchResultTopicKGBB_URI", target_KGBB_URI:"ResearchResultObjectiveRelationAssertionKGBB_URI", required:"false", input_results_in:"added_topic", quantity:"m", query_key:"from_result_cypher_code", instantiates_topicKGBB:"ResearchObjectiveTopicKGBB_URI"}}]->(researchResultObjectiveRelationAssertionkgbb)
    ...
    if request.method == "POST":
        ...
        if request.form:
            ...
            if certainty != "not specified":
                ...
                OPTIONAL MATCH (assertion)-[:HAS_ASSOCIATED_SEMANTIC_UNIT]->(certaintyAssertion:orkg_CertaintyAssertion {{current_version:"true"}})
